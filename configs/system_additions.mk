...
ifneq ($(filter blueline bonito bramble coral crosshatch instantnoodlep miatoll redfin sunfish surya taimen,$(TARGET_DEVICE)),)
...
ifneq ($(filter marlin sailfish blueline bonito bramble coral crosshatch instantnoodlep miatoll redfin sunfish surya taimen,$(TARGET_DEVICE)),)
